...
namespace Lab1EncodeBase64
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            string pathToWrite = @"C:\Users\vsevo\Desktop\University\CS\Lab_1\EncryptText\";
            string pathToCmprssed = @"C:\Users\vsevo\Desktop\University\CS\Lab_1\EncryptText\";
            ...
            try
            {
                ...
                Console.Write("Введіть ім'я закодованого файлу: ");
                encryptFile = Console.ReadLine();
                Console.WriteLine();

                Console.Write("Введіть ім'я стисненого Base64 файлу: ");

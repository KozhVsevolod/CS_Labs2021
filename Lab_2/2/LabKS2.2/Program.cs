...
namespace LabKS2._2
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("*Ділення двійкових чисел (Зсув залишку вправо)*");
            Console.WriteLine(new string('-', 70));
            short x, y;
            Console.WriteLine("(Ділене) Введіть 16-бітове число:");
            x = Int16.Parse(Console.ReadLine());
            Console.WriteLine("(Дільник) Введіть 16-бітове число:");
        ...
        private static string
            RegisterPartToBinaryString(Int64 register, byte bits_amount, bool is_divisor = false) //запис бітів у рядок
        {
        ...
        {
            long register = Dividend, //запис ділене в регістр
                Quotient = 0,
            ...
            Console.WriteLine(new string('-', 70));
            Console.WriteLine("Залишок:    {0} (У десятковій системі: {1})", RegisterPartToBinaryString(register, remainder_bits_amount, true), (register >> 16));
            Console.WriteLine("Частка:     {0} (У десятковій системі: {1})", RegisterPartToBinaryString(Quotient, quotientBitsAmount), Quotient);
        }
    }
}
